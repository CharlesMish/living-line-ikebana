...
(an authored arch on the shared single-station solver). Round 4 appends provisional
`noddingFlower.ts` (one authored neck and bell). Generators consume authored

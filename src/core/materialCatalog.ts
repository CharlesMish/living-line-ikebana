 ...
 * then the Phase 2 fern-frond candidate. The first ten IDs stay in their
 * previous order. Named profiles `reference-pair`, `all-four`, `round3-*`,
 * and `round4-*` do not read this list. `round4-palette` is not this list.
 */
